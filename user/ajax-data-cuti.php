...
$sql = "SELECT kode, nama, tanggal_awal, tanggal_akhir, jumlah, jenis_cuti, ket, status";
$sql.=" FROM cuti";
...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
    ...
    $nestedData[] = '<td><center>
				     ...
				     <a href="cuti.php?aksi=delete&id='.$row['kode'].'&nama='.$row['nama'].'"  data-toggle="tooltip" title="Delete" onclick="return confirm(\'Anda yakin akan menghapus data '.$row['nama'].'?\')" class="btn btn-sm btn-danger"> <i class="glyphicon glyphicon-trash"> </i> </a>
	                 </center></td>';		
