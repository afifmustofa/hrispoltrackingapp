...
if ($query){
	echo "<script>alert('Data Berhasil dimasukan!'); window.location = 'divisi.php'</script>";	
} else {
	echo "<script>alert('Data Gagal dimasukan!'); window.location = 'divisi.php'</script>";	
} 
}
                ...
                <div class="box-body">
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="input-divisi.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Id Divisi</label>
                              <div class="col-sm-8">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
	                              ...
	                              <a href="input-divisi.php" class="btn btn-sm btn-danger">Batal </a>
                              </div>
                          </div>
                      </form>
                  </div>
