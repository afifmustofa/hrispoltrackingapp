            ...
            <div class="card-body">
              ...
              <table class="table" id="tabel-data">
                ...
                <tbody>
                  <?php 
                    $no = 1;
                    $query = mysqli_query($koneksi,"SELECT * FROM jenis_cuti");
                  ...
                  <tr>
                    ...
                    <td class="text-center">
				              <a href="hapusjeniscuti.php?id=<?php echo $row['id_cuti'] ?>"  onclick="return confirm(\'Anda yakin akan menghapus data?/')" class="btn btn-sm btn-danger"> <i class="bi bi-trash"> </i> </a>
                    </td>
                  </tr>
                    <?php } ?>
                </tbody>
