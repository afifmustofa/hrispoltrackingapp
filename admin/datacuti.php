			...
			?>
              ...
              <table id="lookup" class="table table-hover">
                ...
                <tbody>
                  <?php 
                      $no = 1;
                      $query = mysqli_query($koneksi,"SELECT * FROM tb_cuti ORDER BY tanggal DESC");
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <a href="detail-cuti.php?id=<?php echo $row['kode'] ?>" data-toggle="tooltip" title="profile-overview" class="btn btn-sm btn-success"> <i class="bi bi-search"></i> </a>
                      <a href="edit-cuti.php?id=<?php echo $row['kode'] ?>" data-toggle="tooltip" title="profile-edit" class="btn btn-sm btn-primary"> <i class="bi bi-pencil-square"></i> </a>
                      <a href="hapuscuti.php?id=<?php echo $row['kode'] ?>" onclick="return confirm(\'Anda yakin akan menghapus data?/')" class="btn btn-sm btn-danger"> <i class="bi bi-trash"></i> </a>
                      </td>
                    </tr>
                    <?php } ?>
                  </tbody>
