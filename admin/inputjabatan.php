...
$query = mysqli_query($koneksi, "INSERT INTO jabatan (id_jabatan, jabatan) VALUES ('$id_jabatan', '$jabatan')");
if ($query){
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-10">
          <div class="card">
            <div class="card-body">
            <form class="form-horizontal style-form" action="inputjabatan.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input type="submit" name="simpan" value="Simpan"  id="simpan" class="btn btn-sm btn-primary" />&nbsp;
	                 <a href="inputjabatan.php" class="btn btn-sm btn-danger">Batal </a>
                  </div>
                </div>
