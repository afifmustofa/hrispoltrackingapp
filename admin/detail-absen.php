            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label ">Id Absen</div>
                    <div class="col-lg-9 col-md-8"> <?php echo $data['id_absen']?></div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label ">Jam Masuk</div>
                    <div class="col-lg-9 col-md-8"><?php echo $data['jammasuk']; ?></div>
                  </div>
